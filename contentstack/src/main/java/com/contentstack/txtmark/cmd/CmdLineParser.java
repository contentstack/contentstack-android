...
final class CmdLineParser {
     ...
     *
     * @param columnWidth Maximum column width. Words get wrapped at spaces.
     * @param sort        Set {@code true} to sort arguments before printing.
     * @param objs        One or more objects with annotated public fields.
     ...
     *
     * @param args Array of arguments, like the ones provided by
