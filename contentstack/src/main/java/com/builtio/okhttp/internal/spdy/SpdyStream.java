...
import com.builtio.okio.AsyncTimeout;
...
public final class SpdyStream {
  ...
  SpdyStream(int id, SpdyConnection connection, boolean outFinished, boolean inFinished,
    ...
    this.bytesLeftInWriteWindow =
        connection.peerSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE);
    this.source = new SpdyDataSource(
        connection.okHttpSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE));
    ...
    @Override public long read(Buffer sink, long byteCount)
      ...
      synchronized (SpdyStream.this) {
        ...
        if (unacknowledgedBytesRead
            >= connection.okHttpSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE) / 2) {
