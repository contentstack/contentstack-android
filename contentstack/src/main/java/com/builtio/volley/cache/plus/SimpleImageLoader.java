...
import com.builtio.volley.Cache;
import com.builtio.volley.Network;
import com.builtio.volley.Request;
import com.builtio.volley.RequestQueue;
import com.builtio.volley.cache.DiskLruBasedCache;
import com.builtio.volley.cache.DiskLruBasedCache.ImageCacheParams;
import com.builtio.volley.error.VolleyError;
import com.builtio.volley.misc.NetUtils;
import com.builtio.volley.misc.Utils;
import com.builtio.volley.toolbox.BasicNetwork;
import com.builtio.volley.toolbox.HttpClientStack;
...
public class SimpleImageLoader extends ImageLoader {
    ...
    /**
     * Flushed {@link Cache} and clears {@link com.builtio.volley.toolbox.ImageCache}.
     */
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB_MR1)
    private static void setPhotoImageBitmap(final ImageView imageView, final BitmapDrawable bitmapDrawable,
            Resources resources, boolean fadeIn) {
        // If we're fading in and on HC MR1+
        if (fadeIn && Utils.hasHoneycombMR1()) {
            // Use ViewPropertyAnimator to run a simple fade in + fade out animation to update the
