...
public class QueryTestCase {
    ...
    @Test()
    public void test_03_fetchSingleNonExistingEntry() throws Exception {
        Query query = TestCred.stack().contentType("categories").query();
        query.find(new QueryResultsCallBack() {
            @Override
            public void onCompletion(ResponseType responseType, QueryResult queryresult, Error error) {
                if (error == null) {
    ...
    @Test
    public void test_12_fetchEntriesWithOr() throws Exception {

        ContentType ct = TestCred.stack().contentType(contentTypeUID);
    ...
    @Test
    public void test_13_fetchEntriesWithAnd() throws Exception {
