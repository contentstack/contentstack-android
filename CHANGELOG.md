...
- Compile issue fixed with sdk version 31
...
- Removed getPublishDetails() method.
     Entry
- Removed getPublishDetails() method.
...
- Renamed getContentType() to getFileType() method.
- Renamed getUploadUrl() to getUrl() method.
